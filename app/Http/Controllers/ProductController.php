...
class ProductController extends Controller
{
    ...
    public function almatyIn(Request $request)
    {
        ...
        if (Auth::user()->type === 'aktobein'){
            ...
            $city_field = 'to_city';
            $city_value = 'Получено на складе в Чу';
            $city = 'Петропавловск';
            $reg_field = 'reg_city';
            ...
            $city = 'Кызылорда';
            $reg_field = 'reg_city';
        }elseif (Auth::user()->type === 'kostanayin') {
            $city_field = 'to_city';
            $city_value = 'Получено на складе в Костанае';
            $city = 'Костанай';
            $reg_field = 'reg_city';
            ...
            $city_field = 'to_city';
            $city_value = 'Получено на складе в Өскемене';
            $city = 'Өскемен';
            $reg_field = 'reg_city';
        } elseif (Auth::user()->type === 'almatyfin'){
            $city_field = 'to_city';
            $city_value = 'Получено на складе в Алматы';
            $city = 'Алматы';
            $reg_field = 'reg_city';
            ...
            $city = 'Павлодар';
            $reg_field = 'reg_city';
        } elseif (Auth::user()->type === 'ridderin'){
            $city_field = 'to_city';
            $city_value = 'Получено на складе в Риддере';
            $city = 'Риддер';
            $reg_field = 'reg_city';
            ...
            $city_field = 'to_city';
            $city_value = 'Получено на складе в Экибастузе';
            $city = 'Экибастуз';
            $reg_field = 'reg_city';
        }else{
            $city_field = 'to_city';

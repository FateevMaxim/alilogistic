                        ...
                        <div class="absolute w-full bottom-0 p-4">
                            <form method="POST" action="{{ route('almatyout-product') }}" id="searchForm">
                                <div>
                                    <div>
                                        @csrf
                                        @if(env('SELECT_CITY') == true)
                                            <select id="city" name="city" class="block w-full p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
                                                <option selected>Выберите город</option>
                                                <option value="Талдыкурган">Талдыкурган</option>
                                                <option value="Астана">Астана</option>
                                                <option value="Актау">Актау</option>
                                                <option value="Шимкент">Шимкент</option>
                                            </select>
                                        @endif
